 ...
 * @author Tartiflette
 */
public class triceti_cetoran_thruster_L implements EveryFrameWeaponEffectPlugin {
    ...
    private final Vector2f size = new Vector2f(32f, 48f);
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (!SHIP.isAlive()
                || (thruster != null && thruster.isDisabled())) {
